...
import { configureMonaco, defaultEditorOptions, getEditorLanguage } from "@/features/playgrounds/components/EditorConfig"
import type { TemplateFile } from "@/features/playgrounds/lib/path-to-json"
  ...
  return (
    <div className="h-full relative">
      ...
      <Editor
        ...
        // @ts-expect-error - defaultEditorOptions is not assignable to IStandaloneEditorConstructionOptions

...
const TerminalComponent = forwardRef<TerminalRef, TerminalProps>(({ 
  ...
  const initializeTerminal = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        // CSS import might fail in some environments, continue without it
      }
  ...
  useEffect(() => {
    ...
    const currentProcessRef = currentProcess;
    const shellProcessRef = shellProcess;
    const termRef = term;
